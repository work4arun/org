...
// Shared JD content for Director – Research, sourced from the "Deputy
// Director – Publications, Patents & Research Ecosystem" job description on
// file. Grouped into the four standard tab categories: Role Purpose, Roles
// & Responsibilities, Expected Outcome, and Things to be Addressed in MRM.
const researchSections: CatTabSection[] = [
  {
    id: "purpose",
    label: "Role Purpose",
    content: (
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4>A. Daily Research Monitoring</h4>
        <ol className="jd-list">
          <li>
        ...
        <h4>B. Faculty Publication Support</h4>
        <ol className="jd-list">
        ...
        <h4>C. Patent Development and IP Management</h4>
        <ol className="jd-list">
          <li>
        ...
        <h4>D. Conference and Academic Event Ecosystem</h4>
        <ol className="jd-list">
        ...
        <h4>E. Sponsored Research and Funding Support</h4>
        <ol className="jd-list">
        ...
        <h4>F. Research Policy and Process Development</h4>
        <ol className="jd-list">
        ...
        <h4>G. Research Data and Reporting</h4>
        <ol className="jd-list">
        ...
        <h3>Quarterly Responsibilities</h3>
        <ol className="jd-list">
        ...
        <h4>Conference and Event KPIs</h4>
        <ol className="jd-list">
        ...
        <h4>Funding and Research Ecosystem KPIs</h4>
        <ol className="jd-list">
        ...
        <h3>Suggested Minimum Targets</h3>
        <p>
        ...
        <h3>Coordination Required With</h3>
        <ol className="jd-list">
        ...
        <h4>Midday – Faculty and Department Support</h4>
        <ul className="jd-list">
        ...
        <h4>Afternoon – Ecosystem Development</h4>
        <ul className="jd-list">
          <li>
        ...
        <h4>Evening – Documentation and Reporting</h4>
        <ul className="jd-list">
